use v090_json::{initialiser_scores, obtenir_candidats, est_candidat_valide, enregistrer_vote};
use v090_json::configuration::{Configuration, StorageType, LanguageType, ServiceType};
