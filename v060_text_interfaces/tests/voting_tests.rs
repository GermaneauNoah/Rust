use v060_text_interfaces::{initialiser_scores, obtenir_candidats, est_candidat_valide, enregistrer_vote};
use v060_text_interfaces::configuration::{Configuration, StorageType, LanguageType};
...
fn configuration_test() -> Configuration {
    Configuration::new(vec![
        ...
        "bill".to_string(),
        "bao".to_string(),
    ], StorageType::Memory, LanguageType::Fr)
}
