use v080_html::{initialiser_scores, obtenir_candidats, est_candidat_valide, enregistrer_vote};
use v080_html::configuration::{Configuration, StorageType, LanguageType, ServiceType};
