use v070_cli_services::{initialiser_scores, obtenir_candidats, est_candidat_valide, enregistrer_vote};
use v070_cli_services::configuration::{Configuration, StorageType, LanguageType, ServiceType};
...
fn configuration_test() -> Configuration {
    Configuration::new(vec![
        ...
        "bill".to_string(),
        "bao".to_string(),
    ], StorageType::Memory, LanguageType::Fr, ServiceType::Stdio, 0)
}
